class ClientsPage extends TablePage {
        ...
        return `
            <tr>
                ...
                <td class="actions-cell">
                    <button class="btn-icon" onclick="clientsPage.viewClient(${client.user_id})" title="View Details">
    ...
    viewClient(userId) {
        this.showSuccess(`View client ${userId} details - to be implemented`);
        // Можно открыть модальное окно с детальной информацией о клиенте
    }
